  ...
  return (
    <SafeAreaView>
      ...
      <View style={styles.navbar}>
        <View><Pressable onPress={() => router.push("home")}>  <Text style={styles.navbarText}>Black Valley</Text> </Pressable>
        </View>
        <View>
        <Pressable onPress={() => router.push("product")}> <Text style={styles.navbarText}>Products</Text>
        </Pressable></View>
        <View> 
        ...
        <View> <Pressable onPress={() => router.push("order")}>  <Text style={styles.navbarText}>Order here</Text> </Pressable>
        </View>
        <View> 
